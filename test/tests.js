...
describe('Password Complexity', function() {
  ...
  it ('It must contain characters from at a two different character classes (upper- and lower-case letters, letters and symbols, letters and numbers, etc.)', function(done){
    passcomplex('username', 'fsadfasdfasdfasdfasdf!1J$').then(function(retVal){
